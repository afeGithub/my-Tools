<template>
  <div>
      ...
      <div v-show="loginPage"  id="login" class="login" :class="[logining ? 'test':'']">
        ...
        <div class="errorMsg" v-show="errorMsg!==''">
          <p><span style="color: #EA5C54">{{errorMsg}}</span></p>
        </div>

        <div class='encourage'>
          <p>Behind every successful man there's a lot u unsuccessful years.    - Bob Brown</p>
        </div>
      </div>

    <div class='authent' v-show="logining">
