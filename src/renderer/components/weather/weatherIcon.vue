<template>
    <div id="">
        <div class="sunny icon" v-show="weather === 'sunny'"></div>
        <div class="cloudy icon" v-show="weather === 'cloudy'"></div>
        <div class="rainy icon" v-show="weather === 'rainy'"></div>
        <div class="snowy icon" v-show="weather === 'snowy'"></div>
        <div class="rainbow icon" v-show="weather === 'rainbow'"></div>
        <div class="starry icon" v-show="weather === 'starry'"></div>
        <div class="stormy icon" v-show="weather === 'stormy'"></div>
